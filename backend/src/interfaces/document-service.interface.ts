...
export interface IDocumentService {
  ...
  createDocument(title?: string, content?: Delta, userId?: string): Promise<{ id: string }>;
  updateDocumentTitle(id: string, title: string): Promise<boolean>;
  updateDocumentContent(documentId: string, content: string, delta: Delta, socketId: string, userName: string, userId?: string): Promise<void>;
  addUserToDocument(documentId: string, socketId: string, userName: string, userId?: string): Promise<void>;
  ...
  setDocumentPermission(documentId: string, userId: string, role: 'viewer' | 'editor' | 'owner'): Promise<void>;
}
